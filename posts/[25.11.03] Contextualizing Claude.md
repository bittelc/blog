...
I read a beautiful blog post last week by Scott Werner about loading Claude Code up with the correct context on each session start. The blog post is sooo fun because it's one part "this is absurd, how does this work", and one part "it works like this". The main takeaway from the article is that it can be super helpful to provide multiple layers of abstraction and intent to Claude by the following 4 files:
